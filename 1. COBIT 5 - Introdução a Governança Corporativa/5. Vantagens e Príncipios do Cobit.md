...
Passamos grande parte do nosso treinamento enfatizando essa diferença. Ao distinguir Governança de Gestão, entende-se que:

- [ ] A) Governança planeja e executa conforme direcionamento pela gestão.
- [ ] B) Gestão garante que as condições sejam avaliadas, para determinar a direção.
- [x] C) Gestão planeja e executa conforme direcionamento da governança.
  > Governança garante que as condições sejam avaliadas, para determinar a direção. Gestão planeja e executa conforme direcionamento da governança.
- [ ] D) Governança planeja e executa as condições para serem avaliadas e determinadas.

<br>

## [Exercício] Habilitadores

Habilitadores garantem o funcionamento da governança e gestão de TI. Essa abordagem está relacionada a qual princípio do COBIT 5?

- [ ] A) Aplicar um framework integrado único
- [ ] B) Cobrir a organização de ponta a ponta
- [x] C) Permitir uma visão holística
  > No princípio Permitir uma visão holística, o COBIT descreve sete categorias de habilitadores. Uma organização sempre deverá considerar um conjunto de habilitadores interligados.
- [ ] D) Satisfazer as necessidades das Partes Interessadas

<br>

## [Exercício] Uma Visão Holística

Estudamos cada um dos princípios do COBIT 5. Como os habilitadores se relacionam conforme descrito no princípio de Permitir uma visão holística?

- [x] A) Cada habilitador produz resultados para o benefício dos demais habilitadores.
  > Cada habilitador necessita das informações dos demais habilitadores para ser plenamente efetivo. Assim, cada habilitador produz resultados para o benefício dos demais habilitadores.
- [ ] B) Cada habilitador produz resultados para o benefício do habilitador subsequente da ordem numérica.
- [ ] C) Cada habilitador só produz resultados benéficos se não sofrer interferência dos demais habilitador.
- [ ] D) Cada habilitador deve produzir resultados independentes e de uso exclusivo.