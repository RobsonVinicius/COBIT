...
## [Exercício] Definição do Escopo

Definição do escopo da implementação conforme objetivos refere-se a fase 2. Qual questionamento encontraremos nessa fase?

- [ ] A) O que são tendências?
- [ ] B) O que deve ser feito?
- [x] C) Onde estamos agora?
  > Como vimos na aula do ciclo de vida do COBIT 5, "Onde estamos agora", é o questionamento que norteia a fase 2, Definição do escopo da implementação conforme objetivos.
- [ ] D) Onde queremos estar?

<br>

## [Exercício] Definição de uma Meta

Na fase 3, encontramos o seguinte questionamento: Onde queremos estar? Em relação a essa fase, qual a melhor definição?

- [ ] A) Planejamento de soluções práticas através de projetos.
- [ ] B) Monitoramento do atingimento dos resultados esperados.
- [ ] C) Soluções propostas são implementadas e métricas são definidas.
- [x] D) Definição de uma meta de melhorias e identificação de falhas.
  > De acordo com as aulas sobre o ciclo de vida do COBIT, a definição de uma meta de melhorias e identificação de falhas, é a definição correta para a fase 3.

<br>

## [Exercício] Planejamento de Soluções

Qual o questionamento que melhor define a fase 4, onde se realiza o planejamento de soluções práticas através de projetos?

- [x] A) O que deve ser feito?
  > É muito importante o entendimento das fases. O questionamento correto da fase 4 é o que deve ser feito. Nessa fase se realiza o planejamento e também se constrói um eventual Caso de Negócios.
- [ ] B) Já chegamos lá?
...
## [Exercício] Soluções Propostas

Como chegamos lá? Esse questionamento associa-se a fase 5. Qual a melhor definição desta fase?

- [x] A) Soluções propostas são implementadas e métricas são definidas.
  > Como foi visto em aula, soluções propostas são implementadas e métricas são definidas, é a correta definição da fase 5, onde se questiona como chegaremos lá.
- [ ] B) Análise do sucesso da implementação e identificação de novos requisitos.
- [ ] C) Definição de uma meta de melhorias e uma identificação de falhas.
- [ ] D) Monitoramento do atingimento dos resultados esperados.

<br>

## [Exercício] Monitoramento

Ao realizar o monitoramento do atingimento das metas dos resultados esperados, estamos nos referindo a fase 6. Qual o melhor questionamento associado a essa fase?

- [x] A) Já chegamos lá?
  > Ao questionarmos se já chegamos lá, estaremos praticando a fase de realizar o monitoramento do atingimento das metas dos resultados esperados.
- [ ] B) Onde queremos estar?
- [ ] C) Como chegamos lá?
- [ ] D) O que deve ser feito?

<br>

## [Exercício] Análise de Sucesso

A análise de sucesso da implementação e identificação de novos requisitos, associa-se a qual das fases estudadas do ciclo de vida do COBIT?

- [x] A) A última fase, a fase 7.
  > O Ciclo de vida do COBIT, tem um total de 7 fase, sendo a última fase associada a análise do sucesso da implementação e identificação de novos requisitos, ou "como mantemos o impulso".)
- [ ] B) A última fase, a fase 6
- [ ] C) A última fase, a fase 8
- [ ] D) A última fase, a fase 9.